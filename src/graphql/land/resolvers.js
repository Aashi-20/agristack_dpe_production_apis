...
const resolvers = {
  Query: {
    farmerLand: async (_parent, { filter }, _ctx, info) => {
      ...
      if (!where) {
        throw new Error('farmerLand requires at least one filter field (e.g. frCentralId, plotVillageLgdCode)');
      }
